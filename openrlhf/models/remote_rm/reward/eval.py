...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_path", type=str, default="/home/wmk/code/OCRBench_v2/pred_folder/internvl2_5_26b.json", help="Path to the input prediction JSON file."
    )
    parser.add_argument(
        "--output_path", type=str, default="/home/wmk/code/OCRBench_v2/pred_folder/internvl2_5_26b_output.json", help="Path to save the results JSON file."
    )
